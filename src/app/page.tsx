...
const Home = () => {
    return (
        <>
            <section
                className="h-[calc(100vh-94px)] bg-[url('/fondo-inicio-1.webp')] bg-no-repeat bg-cover bg-center relative">
                <div
                    className="absolute text-white bg-black/40 backdrop-blur p-10 w-full max-w-2xl md:left-[23rem] left-1/2 top-1/2 transform -translate-y-1/2 -translate-x-1/2">
