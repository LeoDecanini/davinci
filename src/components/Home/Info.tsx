...
const Info = () => {
  return (
    <section className="flex w-full ">
      <div className="cursor-pointer hover:bg-[#424242] bg-[#525252] w-full text-white p-8">
        <span className="font-bold text-xl">Descuentos</span>
        <h2 className="pt-5 font-bold text-4xl pb-5">
      ...
      <div className="cursor-pointer hover:bg-[#313131] bg-[#3d3d3d] w-full text-white p-8">
      ...
      <div className="cursor-pointer hover:bg-[#1d1d1d] bg-[#2b2b2b] w-full text-white p-8">
